...
[NOTE]
====
Se você estiver utilizando outro SO que não o Linux, no macOS por exemplo, antes de executar o `docker-compose`, será necessário a instalação e a configuração do {uri-docker-machine}[docker-machine].
